...
elseif PLANE_ICAO == 'BE9L' then
    ...
    qmcp737c:CfgCmd(16, 'sim/autopilot/altitude_down', 'sim/operation/test_none')
    qmcp737c:CfgCmd(17, 'sim/autopilot/altitude_up', 'sim/operation/test_none')
    ...
    qmcp737c:CfgCmd(24, 'sim/autopilot/nose_down', 'sim/operation/test_none')
    qmcp737c:CfgCmd(25, 'sim/autopilot/nose_up', 'sim/operation/test_none')
    qmcp737c:CfgCmd(26, 'sim/GPS/g1000n2_crs_down', 'sim/operation/test_none')
    qmcp737c:CfgCmd(27, 'sim/GPS/g1000n2_crs_up', 'sim/operation/test_none')
    ...
    qmcp737c:CfgCmd(48, 'sim/instruments/barometer_down', 'sim/operation/test_none')
    qmcp737c:CfgCmd(49, 'sim/instruments/barometer_up', 'sim/operation/test_none')
    ...
    qmcp737c:CfgCmd(0, 'sim/radios/obs1_down', 'sim/operation/test_none')
    qmcp737c:CfgCmd(1, 'sim/radios/obs1_up', 'sim/operation/test_none')
    qmcp737c:CfgCmd(4, 'sim/radios/adf1_card_down')
    qmcp737c:CfgCmd(5, 'sim/radios/adf1_card_up')
    qmcp737c:CfgCmd(12, 'sim/autopilot/heading_down', 'sim/operation/test_none')
    qmcp737c:CfgCmd(13, 'sim/autopilot/heading_up', 'sim/operation/test_none')
    qmcp737c:CfgCmd(16, 'sim/autopilot/altitude_down', 'sim/operation/test_none')
    qmcp737c:CfgCmd(17, 'sim/autopilot/altitude_up', 'sim/operation/test_none')
    qmcp737c:CfgCmd(24, 'sim/autopilot/vertical_speed_down', 'sim/operation/test_none')
    qmcp737c:CfgCmd(25, 'sim/autopilot/vertical_speed_up', 'sim/operation/test_none')
    qmcp737c:CfgCmd(26, 'sim/radios/obs2_down', 'sim/operation/test_none')
    qmcp737c:CfgCmd(27, 'sim/radios/obs2_up', 'sim/operation/test_none')
